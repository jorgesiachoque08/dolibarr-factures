 ...
 */
class CustompdoMyBodytech implements
    ...
    RefreshTokenInterface
{
    ...
    public function getUser($username)
    {
        ...
        $stmt = $this->db->prepare($sql = sprintf('SELECT * from %s where (email=:username or user_name =:username) and is_active=1' , $this->config['user_table']));
